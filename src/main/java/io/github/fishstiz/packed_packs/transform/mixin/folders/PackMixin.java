...
public abstract class PackMixin implements FilePack, ConfiguredPack {
    ...
    // Sombras de campos existentes en 1.20.1 para implementar ConfiguredPack
    ...
    // --- Implementación de ConfiguredPack (Adaptado a 1.20.1) ---
    ...
    public boolean packed_packs$isConfigured() {
        return this.packed_packs$resolver != null;
    }

    @Override
    public boolean packed_packs$isRequired() {
        return this.required;
    }

    @Override
    public boolean packed_packs$isFixed() {
        return this.fixedPosition;
    }

    @Override
    public Pack.Position packed_packs$getDefaultPosition() {
